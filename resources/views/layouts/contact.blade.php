...
<head>
    ...
    <title>{{ $title ?? 'Contact Us - Rorena Tours' }}</title>

    <!-- SEO Meta Tags -->
    <meta name="description" content="Contact Rorena Tours for safari bookings, tour information, and travel inquiries in Uganda. Get in touch with our expert travel consultants.">
    <meta name="keywords" content="contact rorena tours, uganda tours contact, safari booking contact, travel inquiry uganda">
    <meta name="author" content="Rorena Tours">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Contact Us - Rorena Tours">
    <meta property="og:description" content="Get in touch with Rorena Tours for all your Uganda safari and tour needs.">
...
<body class="bg-gray-50 font-sans" x-data="{ open: false }">
    <!-- Contact Hero Section with Navigation -->
    <section class="relative h-96 bg-cover bg-center" style="background-image: url('/images/contact-hero.jpg');">
        <!-- Overlay -->
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="hidden lg:flex items-center space-x-6">
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }">
                            ...
                            <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg py-2 w-48 z-50">
                                ...
                                <a href="{{ route('contact') }}" class="block px-4 py-2 text-green-600 bg-green-50 font-medium transition-colors">Contact Us</a>
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" class="lg:hidden bg-white/95 backdrop-blur-sm mt-2 rounded-lg">
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <a href="{{ route('contact') }}" class="block px-3 py-2 text-green-600 bg-green-50 font-medium rounded transition-colors">Contact</a>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <div class="flex justify-center space-x-4 mb-8">
                        <a href="https://facebook.com/rorenatours" target="_blank" class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://twitter.com/rorenatours" target="_blank" class="w-10 h-10 bg-blue-400 rounded-full flex items-center justify-center text-white hover:bg-blue-500 transition-colors">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://youtube.com/rorenatours" target="_blank" class="w-10 h-10 bg-red-600 rounded-full flex items-center justify-center text-white hover:bg-red-700 transition-colors">
                            <i class="fab fa-youtube"></i>
                        </a>
                        <a href="https://instagram.com/rorenatours" target="_blank" class="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center text-white hover:bg-purple-700 transition-colors">
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="fullname" name="fullname" placeholder="John Doe" class="form-input">
                    </div>

                    <!-- Email Address -->
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                        <input type="email" id="email" name="email" placeholder="sample@yourcompany.com" class="form-input">
                    </div>
                    ...
                    <!-- Interested In -->
                    <div>
                        <label for="interest" class="block text-sm font-medium text-gray-700 mb-2">Interested In</label>
                    ...
                    <!-- Number of Person -->
                    <div>
                        <label for="persons" class="block text-sm font-medium text-gray-700 mb-2">Number of Person</label>
                        <select id="persons" name="persons" class="form-input">
                    ...
                    <!-- Submit Button -->
                    <div class="pt-4">
                        <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-8 rounded-lg transition-colors duration-200">
                            Send Message
                        </button>
                    </div>
                </form>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    <!-- Who We Are -->
                    <div class="bg-indigo-700 text-white p-8 rounded-lg">
                        <h3 class="text-2xl font-bold mb-6">Who we are</h3>
                        <p class="text-indigo-100 leading-relaxed">
                            Rorena Tours and Safaris is a Safaris company that does both cultural and Tourist Trips in Uganda, and her neighbors in Kenya, Tanzania, Rwanda and DRC.
                        </p>
                    </div>
                    ...
                    <div class="bg-indigo-700 text-white p-8 rounded-lg">
                        ...
                        <p class="text-indigo-100 leading-relaxed">
                            Wild life Safaris, Gorilla Safaris, white water rafting, weekend holidays, Honey Moon, Car hire, Team building and retreats, Adventure Safaris, Filming Safaris, Cultural tours,City tours, Airport pick up and drop, Bird watching and Air ticketing.
                        </p>
                    </div>
                </div>
            </div>
