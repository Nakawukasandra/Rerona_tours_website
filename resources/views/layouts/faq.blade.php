...
<head>
    ...
    <title>{{ $title ?? 'Frequently Asked Questions - Rorena Tours' }}</title>

    <!-- SEO Meta Tags -->
    <meta name="description" content="Find answers to common questions about Rorena Tours and our services. Get quick answers to your safari and tour inquiries.">
    <meta name="keywords" content="rorena tours faq, uganda tours questions, safari faq, travel questions uganda">
    <meta name="author" content="Rorena Tours">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Frequently Asked Questions - Rorena Tours">
    <meta property="og:description" content="Find answers to common questions about Rorena Tours and our services.">
...
<body class="bg-gray-50 font-sans" x-data="{ open: false }">
    <!-- FAQ Hero Section with Navigation -->
    <section class="relative h-96 bg-cover bg-center" style="background-image: url('/images/faq-hero.jpg');">
        <!-- Overlay -->
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="hidden lg:flex items-center space-x-6">
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }">
                            ...
                            <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg py-2 w-48 z-50">
                                ...
                                <a href="{{ route('faqs') }}" class="block px-4 py-2 text-green-600 bg-green-50 font-medium transition-colors">FAQs</a>
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" class="lg:hidden bg-white/95 backdrop-blur-sm mt-2 rounded-lg">
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <a href="{{ route('contact') }}" class="block px-3 py-2 text-gray-700 hover:text-green-600 hover:bg-green-50 rounded transition-colors">Contact</a>
                        <a href="{{ route('faqs') }}" class="block px-3 py-2 text-green-600 bg-green-50 font-medium rounded transition-colors">FAQs</a>
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-2/3">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">Are there any extra fees that I will have to pay on top of the listed price?</h3>
                                    </div>
                            ...
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">Should I print a receipt to show the tour guide?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                            ...
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">How much does it cost to do a private tour?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                ...
                <!-- Preparation Section -->
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Preparation</h2>
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">What should I wear?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                            ...
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">What do I need to bring?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                ...
                <!-- Reservation Section -->
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Reservation</h2>
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">What is your refund policy?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                            ...
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">Do you offer 30 days money back guarantee?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                            ...
                            <button class="w-full px-6 py-4 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900">Do I have to make a reservation?</h3>
                                    </div>
                                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
            ...
            <div class="lg:w-1/3">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <form class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" placeholder="sample@yourcompany.com" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="persons" name="persons" placeholder="1 person" min="1"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>

                        <!-- Send Button -->
                        <button type="submit" 
                                class="w-full bg-blue-600 text-white py-3 px-4 rounded-md font-medium hover:bg-blue-700 transition-colors duration-200">
                            Send Message
                        </button>
                    </form>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">More Information</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start text-gray-600">
                            ...
                            <span>Kikuubo, Wakiso Uganda</span>
                        </div>
                        ...
                        <div class="flex items-start text-gray-600">
                            ...
                            <div>
                                <div>Mon – Sat 8:00 – 18:00 Sunday</div>
                                <div class="text-red-600 font-medium">CLOSED</div>
                            </div>
                        </div>
                    </div>
                </div>
